...
const EventForm = ({ userId, type, event, eventId }: EventFormProps) => {
   ...
   async function onSubmint(values: z.infer<typeof eventFormSchema>) {
   ...
   return (
      <Form {...form}>
         <form onSubmit={form.handleSubmit(onSubmint)} className="flex flex-col gap-5">
                  ...
                  render={({ field }) => (
                     <FormItem className="w-full">
                        <FormControl className="h-72">
                           <Textarea placeholder="Description" {...field} className="textdarea rounded-2xl" />
                        </FormControl>
